...
- **Working directory** (where the site code will live, separate from this framework):
- **Existing repo?** (URL if so, otherwise blank)
- **Existing site to migrate from?** (URL + what's wrong with it, if relevant)
...
- **Who maintains the site after launch?** (you / a team / an agency / nobody decided)
- **Technical expertise of the maintainer:** (designer / developer / non-technical / mixed)
- **Languages and frameworks the team already knows and wants to keep using:**
- **Languages or frameworks the team has decided against:**
- **Who writes content** (product copy, articles, docs, etc.)?
- **Who answers customer questions** (support, sales, none)?
...
- **What is the site for, in one sentence?**
- **The single most important thing it must do** (sell / inform / capture / persuade / entertain / connect / support / showcase / operate):
- **How will you know it's working?** (one or two concrete metrics, with rough target):
- **By when?** (3 months / 6 months / 12 months):

---

## Compliance and regulation

- **Regions of the world your users live in** (matters for laws — EU, California, Brazil, China, etc.):
...
- **Do you have legal counsel?** (yes / no / TBD)
...
- **How fast must this feel?** (instant / fast / acceptable / no opinion)
- **Page-load target (LCP):** (e.g., < 2.5s / no opinion)
- **Hard cap on initial JavaScript bundle:** (e.g., < 200KB / no opinion)
- **Hard cap on page weight:** (e.g., < 1MB / no opinion)
...
- **WCAG target:** (A / AA / AAA / not sure — pick AA if unsure)
- **Is accessibility a legal mandate for this site?** (yes / no / unsure)
- **Will the team test manually with screen readers and keyboard-only?** (yes / no / want help setting this up)
...
- **Existing vendor accounts** (check those already in place):
  ...
  - [ ] Other:
- **Things you must use:** (e.g., "we already use Postgres on RDS")
- **Things you must not use:** (e.g., "no Google products" / "no JS-heavy frameworks")
- **Open-source vs proprietary preference:** (strong OSS / OSS-leaning / no preference / proprietary-leaning)
- **Build budget cap:**
...
- **Where does your content currently live?** (notes / Google Docs / spreadsheets / existing CMS / nowhere yet):
- **How much content?** Rough counts:
  - Products: _____
  - Articles / posts: _____
  - Doc pages: _____
  - Other pages: _____
- **Integrations the site must talk to:** (CRM, payments, search, ERP, ticketing, identity, analytics, etc.):
- **Webhooks or events** the site needs to consume or emit:
- **AI / ML features required:** (chat, recommendations, search, generation — or "none")
...
- **Sites you dislike** (1–2 URLs + why):
  - _URL_ — _why_
- **Three adjectives for how this should feel:**
- **Three adjectives for how it should NOT feel:**

---

## Hosting and deployment

- **Preferred host(s):** (Vercel, Netlify, Cloudflare, AWS, GCP, Azure, self-hosted, no preference)
- **Preferred regions:**
- **Edge / CDN needs:** (must be global / specific regions / no opinion)
- **CI/CD platform preference:** (GitHub Actions / GitLab / CircleCI / other / no preference)
- **Domain situation:** (already own + name / need to buy / transferring / haven't decided)

---

## Operational appetite

- **Post-launch ops capacity:** (zero — must be hands-off / a few hours/month / a team is dedicated)
- **On-call expectations:** (24/7 paging / business-hours / best-effort / none)
- **Uptime target:** (99.99% / 99.9% / 99% / best-effort / no opinion)
- **Backup and disaster recovery appetite:** (rigorous / moderate / minimal)
